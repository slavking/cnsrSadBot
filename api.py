...
def post_chat(body, chat, name="hohilbot", convo="General", trip="", file="" ):
    post_params = []
    ...
    req = urllib2.Request(uri, datagen, headers)
    return opener.open(req)
    #return post('https://sadchan.sytes.net/chat/'+chat, post_params)
...
def login(callback=on_chat):
    #image_response = fetch('https://sadchan.sytes.net/captcha.jpg')
    ...
    #login_response = post('https://sadchan.sytes.net/login', post_params)
